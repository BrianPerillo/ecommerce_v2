                                ...
                                <li class="pt-4">Hombre
                                    <ul class="pb-2">
                                        @foreach($categories as $category)
                                            <li class="p-2"><a href="{{ route('productos.'. strtolower($category->name), [$category->id, $male->id]) }}">{{$category->name}}</a></li>
                                        @endforeach
                        ...
                        <x-jet-nav-link href="" {{-- :active="request()->routeIs('productos.buzos')" --}}>
                            <ul class="menu m-0">
                                <li class="pt-4">Mujer
                                    <ul class="pb-2">
                                        @foreach($categories as $category)
                                            <li class="p-2"><a href="{{ route('productos.'. strtolower($category->name), [$category->id, $female->id]) }}">{{$category->name}}</a></li>
                                        @endforeach
